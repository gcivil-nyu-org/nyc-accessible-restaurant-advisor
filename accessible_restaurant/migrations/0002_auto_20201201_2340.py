# Generated by Django 3.1.2 on 2020-12-02 04:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user_profile',
            name='phone',
            field=models.PositiveSmallIntegerField(blank=True, default=0, validators=[accessible_restaurant.models.User_Profile.validate_phone]),
        ),
        migrations.AlterField(
            model_name='user_profile',
            name='state',
        ...
        migrations.AlterField(
            model_name='user_profile',
            name='zip_code',
            field=models.PositiveSmallIntegerField(blank=True, default=0, validators=[accessible_restaurant.models.User_Profile.validate_zip]),
        ),
        migrations.CreateModel(
